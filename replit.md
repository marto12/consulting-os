...
- **Routing**: Two main screens — `app/index.tsx` (project list/creation) and `app/project/[id].tsx` (project detail with tabbed interface for overview, issues, hypotheses, runs, summary, and logs)
